...
### Step #1
Download the dataset file for analysis: The first step is to download a dataset file for analysis. You can use the example file provided by clicking on the "Download Sample Data" link below.
